...
provider "yandex" {
  token     = "y0__xCKsIeWCBjB3RMgy8jOsBP93nA9ALs__v9LOJeY74Khbeq51A"
  folder_id = "b1gurl2fjhl4gs9ln8nn"
}
...
resource "yandex_mdb_clickhouse_cluster" "clickhouse_starschema" {
  ...
  admin_password          = "Ваш_длинный_пароль_2023!"
  version                 = "25.5"
  ...
  clickhouse {
    ...
    config {
      ...
      query_log_retention_time        = 86400000 # 1 день
      query_thread_log_enabled        = true
      query_thread_log_retention_size = 536870912
      query_thread_log_retention_time = 86400000 # 1 день
      part_log_retention_size         = 536870912
      part_log_retention_time         = 86400000 # 1 день
      metric_log_enabled              = true
      metric_log_retention_size       = 536870912
      metric_log_retention_time       = 86400000 # 1 день
      trace_log_enabled               = true
      trace_log_retention_size        = 536870912
      trace_log_retention_time        = 86400000 # 1 день
      text_log_enabled                = true
      text_log_retention_size         = 536870912
      text_log_retention_time         = 86400000 # 1 день
